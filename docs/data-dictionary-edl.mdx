...
<Accordion title="Permits">
    ...
    | property_type | `string` | The type of property | "Single Family Dwelling" | Shovels |
    | property_type_detail | `string` | The detailed type of property | "Single Family Dwelling" | Shovels |
