...
All Free Trial accounts are also provided with an API Key, which has a separate, non-time based limit of 250 requests. Even if your Shovels Online free trial expires, you may continue to test the API with this key until you hit your limit. 
