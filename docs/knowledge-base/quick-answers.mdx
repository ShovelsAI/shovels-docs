...
### What is Charlie AI?
Charlie is Shovels' AI research agent at [charlie.shovels.ai](https://charlie.shovels.ai). Ask permit data questions in plain English and get instant answers — no filters, downloads, or code required. Uses your API credits. See [What is Charlie AI?](/docs/knowledge-base/shovels-online/charlie).
