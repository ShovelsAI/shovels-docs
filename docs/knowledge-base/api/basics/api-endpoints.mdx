...
**An API endpoint is a specific URL that represents a particular function or query.** The Shovels API (v2) provides access to permits, decisions, contractors, addresses, and supporting resources. For complete endpoint documentation, see the [API Reference](/api-reference).
