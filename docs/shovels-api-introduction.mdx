...
<Info>
The free API key has a limited quota. If you hit the limit and need more, please reach out to [sales@shovels.ai](mailto:sales@shovels.ai) or call us at [1-800-511-7457](tel:+18005117457).
</Info>
...
API Key free trials include quota for 250 records with no time limit or credit card required. Each record returned by the API counts against your quota—for example, a search returning 100 permits uses 100 quota.

If you exceed your quota and still need more, please reach out to [Sales](mailto:sales@shovels.ai) for an extension.
