...
<Update label="V2.0.6" description="2025-05-06">
  <Tabs>
    ...
    <Tab title="API">
      ...
      <Warning>This replaces the former `page` parameter for pagination. This old method will be supported for an additional three months, at which point it will be deprecated.</Warning>
